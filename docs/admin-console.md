...
Test project only: migration and Edge Function deployed; local and deployed-handler permission tests passed. Production migration, operator bootstrap and console deployment remain pending approval to merge/release.
